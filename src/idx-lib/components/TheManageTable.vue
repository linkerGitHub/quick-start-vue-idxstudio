<template>
  <div>
    ...
    <el-row>
      <el-pagination
        background
        @size-change="thePaginationOpt.handleTableSizeChange"
        @current-change="thePaginationOpt.handleCurrentChange"
  ...
  export default {
    ...
    methods: {
      ...
      newOneReq: function () {
        let theTab = this
        theTab.tableOptions.loading = true
        theTab.networkReq.postReq(theTab.tableOptions.newOneData)
          .then(function (response) {
